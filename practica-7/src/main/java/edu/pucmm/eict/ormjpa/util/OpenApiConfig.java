                                        ...
                                        .withDefinitionConfiguration((version, openApiDefinition) -> {
                                                ...
                                                // .variable("basePath", "Base path of the server", "", "", "v1")
                                                                ...
                                                                .withSecurity(openApiSecurity -> openApiSecurity
                                                                                ...
                                                                                .withOAuth2("OAuth2",
                                                                                                ...
                                                                                                oauth2 -> oauth2
                                                                                                                .withClientCredentials(
                                                                                                                                "https://api.example.com/credentials/authorize")
                                                                                                                .withImplicitFlow(
                                                                                ...
                                                                                .withGlobalSecurity("OAuth2",
                                                                                                globalSecurity -> globalSecurity
                                                                                                                .withScope("write_pets")
                                                                                                                .withScope("read_pets")))
                                                                .withDefinitionProcessor(content -> { // you can add
                                                                                                      // whatever you
                                                                                                      // want to this
                                                                                                      // document using
                                                                                                      // your favourite
