...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Javalin app = Javalin.create(config -> {
            ...
            /*
             * Este es el camino largo, por si tengo más de un sistema de plantilla, es
             * decir,
                        ...
                        .withDefinitionConfiguration((version, openApiDefinition) -> {
                            openApiDefinition
                                    .withInfo(openApiInfo -> openApiInfo
                                            ...
                                            .contact("API Soporte", "https://icc352.pucmm.edu.do/soporte",
                                                    "support@example.com")
                            ...
                            // .variable("basePath", "Base path of the server", "", "", "v1")
                                    ...
                                    .withSecurity(openApiSecurity -> openApiSecurity
                                            ...
                                            .withOAuth2("OAuth2", "API usando OAuth 2", oauth2 -> oauth2
                                                    .withClientCredentials(
                                                            "https://icc352.pucmm.edu.do/credentials/authorize")
                                                    .withImplicitFlow("https://icc352.pucmm.edu.do/oauth2/authorize",
                                                            flow -> flow
                                                                    .withScope("read_pets", "read your pets")
                                                                    .withScope("write_pets",
                                                                            "modify pets in your account")))
                                            .withGlobalSecurity("OAuth2", globalSecurity -> globalSecurity
                                                    .withScope("write_pets")
                                                    .withScope("read_pets")))
                                    .withDefinitionProcessor(content -> { // you can add whatever you want to this
                                                                          // document using your favourite json api
        ...
        app.get("/", ctx -> {
            ...
            ctx.render("/templates/ClienteREST.html", modelo);
        });
